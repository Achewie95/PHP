    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="<?php echo e(route('products.store')); ?>">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="productID" name="productID" value="<?php echo e(old("productID")); ?>" required>
            </div>
                <div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" class="form-control" id="weight" name="weight" value="<?php echo e(old("weight")); ?>" required>
            </div>
                <div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="manufacturer" name="manufacturer" value="<?php echo e(old("manufacturer")); ?>" required>
            </div>
                <div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="number" step="1" class="form-control" id="quantity" name="quantity" value="<?php echo e(old("quantity")); ?>" required>
            </div>
                <div>
...
</html><?php /**PATH C:\Users\amosc\OneDrive\Desktop\PhP\Project\laravel\resources\views/addProduct.blade.php ENDPATH**/ ?>